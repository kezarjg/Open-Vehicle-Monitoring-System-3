...
static const OvmsPoller::poll_pid_t obdii_polls[] = {
  ...
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_CONTROL_SYSTEM_MODE, { 0, 1, 1, 1, 1, 1, 1}, 0, ISOTP_STD }, // { 0, 1, 1, 1, 1, 1, 1} (Checked)
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_CHARGING_LID, { 0, 10, 10, 0, 0, 0, 0}, 0, ISOTP_STD }, // { 0, 10, 10, 0, 0, 0, 0} (Checked)

    // Combined polls
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_BATTERY_SOC, { 0, 0, 1, 1, 1, 1, 1}, 0, ISOTP_STD }, // { 0, 0, 1, 1, 1, 1, 1} (Checked)
  { HYBRID_BATTERY_SYSTEM_TX, HYBRID_BATTERY_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_BATTERY_SOC_BMS, {0, 0, 1, 1, 1, 1, 1}, 0, ISOTP_STD }, // {0, 0, 1, 1, 1, 1, 1} (Checked)
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_READY_SIGNAL, { 0, 0, 1, 1, 1, 1, 1}, 0, ISOTP_STD }, // { 0, 0, 1, 1, 1, 1, 1} (Checked)
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_BATTERY_VOLTAGE_AND_CURRENT, { 0, 0, 1, 1, 1, 1, 1}, 0, ISOTP_STD }, // { 0, 0, 1, 1, 1, 1, 1} (Checked)
  { HYBRID_BATTERY_SYSTEM_TX, HYBRID_BATTERY_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_BATTERY_TEMPERATURES, {0, 0, 10, 10, 10, 10, 10}, 0, ISOTP_STD }, // {0, 0, 10, 10, 10, 10, 10} (Checked)
  { HYBRID_BATTERY_SYSTEM_TX, HYBRID_BATTERY_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_BATTERY_CELL_VOLTAGES, {0, 0, 5, 5, 5, 5, 5}, 0, ISOTP_STD }, // 0x182E: 192-byte panel (96 × uint16 BE × 5/65535 V)

    // Driving polls
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_VEHICLE_SPEED, { 0, 0, 1, 0, 0, 0, 0}, 0, ISOTP_STD }, // { 0, 0, 1, 0, 0, 0, 0} (Checked)
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_SHIFT_POSITION, { 0, 0, 1, 0, 0, 0, 0}, 0, ISOTP_STD }, // { 0, 0, 1, 0, 0, 0, 0} (Checked)
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_ODOMETER, { 0, 0, 1, 0, 0, 0, 0}, 0, ISOTP_STD }, // { 0, 0, 1, 0, 0, 0, 0} (Checked)
  { AIR_CONDITIONER_TX, AIR_CONDITIONER_RX, VEHICLE_POLL_TYPE_READDATA, PID_AMBIENT_TEMPERATURE, { 0, 0, 10, 0, 0, 0, 0}, 0, ISOTP_STD }, // {0, 0, 10, 0, 0, 0, 0} (Checked)
  { AIR_CONDITIONER_TX, AIR_CONDITIONER_RX, VEHICLE_POLL_TYPE_READDATA, PID_CABIN_TEMPERATURE, { 0, 0, 10, 0, 0, 0, 0}, 0, ISOTP_STD }, // {0, 0, 10, 0, 0, 0, 0} (Checked)
  { AIR_CONDITIONER_TX, AIR_CONDITIONER_RX, VEHICLE_POLL_TYPE_READDATA, PID_HVAC_SETPOINT, {0, 0, 10, 0, 0, 0, 0}, 0, ISOTP_STD }, // {0, 0, 10, 0, 0, 0, 0} (Checked)

    // Charging polls
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_AMBIENT_TEMPERATURE_EV, { 0, 0, 0, 10, 10, 10, 10}, 0, ISOTP_STD }, // { 0, 0, 0, 10, 10, 10, 10} (Checked)
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_CHARGING_CONTROL_STATUS, { 0, 0, 0, 1, 1, 1, 1}, 0, ISOTP_STD }, // { 0, 0, 0, 1, 1, 1, 1} (Checked)
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_PISW_STATUS, { 0, 5, 0, 10, 10, 10, 10}, 0, ISOTP_STD }, // AWAKE=5s: feeds wake-reconcile fresh PISW + cold-plug cable-detect arm logic
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_CHARGING_VOLTAGE_TYPE, { 0, 0, 0, 10, 10, 10, 10}, 0, ISOTP_STD }, // { 0, 0, 0, 10, 10, 10, 10} (Checking)
