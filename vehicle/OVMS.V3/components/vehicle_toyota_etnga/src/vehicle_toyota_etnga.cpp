...
static const OvmsPoller::poll_pid_t obdii_polls[] = {
  ...
  { AIR_CONDITIONER_TX, AIR_CONDITIONER_RX, VEHICLE_POLL_TYPE_READDATA, PID_AMBIENT_TEMPERATURE, { 0, 60, 60, 60}, 0, ISOTP_STD }, // { 0, 60, 60, 60}
  { AIR_CONDITIONER_TX, AIR_CONDITIONER_RX, VEHICLE_POLL_TYPE_READDATA, PID_CABIN_TEMPERATURE, { 0, 60, 60, 60}, 0, ISOTP_STD }, // { 0, 60, 60, 60}
//  { AIR_CONDITIONER_TX, AIR_CONDITIONER_RX, VEHICLE_POLL_TYPE_READDATA, PID_HVAC_SETPOINT, {0, 60, 60, 60}, 0, ISOTP_STD },
