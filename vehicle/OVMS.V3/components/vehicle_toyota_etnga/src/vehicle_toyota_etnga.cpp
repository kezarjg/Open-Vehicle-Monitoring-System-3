...
static const OvmsPoller::poll_pid_t obdii_polls[] = {
  ...
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_SHIFT_POSITION, { 0, 0, 1, 0}, 0, ISOTP_STD }, 
  { HYBRID_CONTROL_SYSTEM_TX, AIR_CONDITIONER_RX, VEHICLE_POLL_TYPE_READDATA, PID_AMBIENT_TEMPERATURE, {0, 60, 60, 60}, 0, ISOTP_STD },
//  { HYBRID_CONTROL_SYSTEM_TX, AIR_CONDITIONER_RX, VEHICLE_POLL_TYPE_READDATA, PID_CABIN_TEMPERATURE, {0, 60, 60, 60}, 0, ISOTP_STD },
//  { HYBRID_CONTROL_SYSTEM_TX, AIR_CONDITIONER_RX, VEHICLE_POLL_TYPE_READDATA, PID_HVAC_SETPOINT, {0, 60, 60, 60}, 0, ISOTP_STD },
