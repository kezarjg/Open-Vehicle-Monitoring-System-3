...
static const OvmsPoller::poll_pid_t obdii_polls[] = {
  ...
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_PISW_STATUS, { 0, 0, 0, 10, 10, 10, 10}, 0, ISOTP_STD }, // { 0, 0, 0, 10, 10, 10, 10} (Checked)
