...
static const OvmsPoller::poll_pid_t obdii_polls[] = {
  ...
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_CHARGING_LID, { 0, 1, 0, 1}, 0, ISOTP_STD },
    ...
    // Combined polls
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_BATTERY_SOC, { 0, 1, 1, 1}, 0, ISOTP_STD }, // { 0, 1, 1, 1}
  { HYBRID_BATTERY_SYSTEM_TX, HYBRID_BATTERY_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_BATTERY_SOC_BMS, {0, 1, 1, 1}, 0, ISOTP_STD }, // {0, 1, 1, 1}
  { AIR_CONDITIONER_TX, AIR_CONDITIONER_RX, VEHICLE_POLL_TYPE_READDATA, PID_AMBIENT_TEMPERATURE, { 0, 10, 10, 10}, 0, ISOTP_STD }, // {0, 10, 10, 10}
  { AIR_CONDITIONER_TX, AIR_CONDITIONER_RX, VEHICLE_POLL_TYPE_READDATA, PID_CABIN_TEMPERATURE, { 0, 10, 10, 10}, 0, ISOTP_STD }, // {0, 10, 10, 10}
  { AIR_CONDITIONER_TX, AIR_CONDITIONER_RX, VEHICLE_POLL_TYPE_READDATA, PID_HVAC_SETPOINT, {0, 10, 10, 10}, 0, ISOTP_STD }, // {0, 10, 10, 10}
  { HYBRID_BATTERY_SYSTEM_TX, HYBRID_BATTERY_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_BATTERY_TEMPERATURES, {0, 10, 10, 10}, 0, ISOTP_STD }, // {0, 10, 10, 10}

    // Driving polls
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_BATTERY_VOLTAGE_AND_CURRENT, { 0, 1, 1, 1}, 0, ISOTP_STD }, // { 0, 1, 1, 1}
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_ODOMETER, { 0, 0, 1, 0}, 0, ISOTP_STD }, // { 0, 0, 1, 0}
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_VEHICLE_SPEED, { 0, 0, 1, 0}, 0, ISOTP_STD }, // { 0, 0, 1, 0}
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_SHIFT_POSITION, { 0, 0, 1, 0}, 0, ISOTP_STD }, // { 0, 0, 1, 0}
  ...
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_BATTERY_CHARGING_POWER, { 0, 0, 0, 1}, 0, ISOTP_STD }, // { 0, 0, 0, 1}
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_CHARGER_INPUT_POWER, { 0, 0, 0, 1}, 0, ISOTP_STD }, // { 0, 0, 0, 1}
